...
// Serviços
    ...
    Route::middleware('auth:sanctum')->post('pedidos/pagamento/{pedido}', [App\Http\Controllers\Api\PagamentoController::class, 'store'])->name('auth.mobile.pedidos.pagamento');
