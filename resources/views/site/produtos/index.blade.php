                    ...
                    <div class="col-lg-9 order-lg-1">
                        ...
                        <div class="row pb-4">
                            <div class="col-sm-12 col-6 product-default left-details product-list mb-2">
                                <figure>
                                    <a href="product.html">
                                        <img src="{{asset('assets/images/products/product-1.jpg')}}" width="250" height="250" alt="product" />
                                        <img src="{{asset('assets/images/products/product-1-2.jpg')}}" width="250" height="250" alt="product" />
                                    </a>
                                </figure>
                            ...
                            <div class="col-sm-12 col-6 product-default left-details product-list mb-2">
                                <figure>
                                    <a href="product.html">
                                        <img src="{{asset('assets/images/products/product-2.jpg')}}" width="250" height="250" alt="product" />
                                        <img src="{{asset('assets/images/products/product-2-2.jpg')}}" width="250" height="250" alt="product" />
                                    </a>
                                </figure>
                            ...
                            <div class="col-sm-12 col-6 product-default left-details product-list mb-2">
                                <figure>
                                    <a href="product.html">
                                        <img src="{{asset('assets/images/products/product-3.jpg')}}" width="250" height="250" alt="product" />
                                        <img src="{{asset('assets/images/products/product-3-2.jpg')}}" width="250" height="250" alt="product" />
                                    </a>
                                </figure>
                            ...
                            <div class="col-sm-12 col-6 product-default left-details product-list mb-2">
                                <figure>
                                    <a href="product.html">
                                        <img src="{{asset('assets/images/products/product-4.jpg')}}" width="250" height="250" alt="product" />
                                        <img src="{{asset('assets/images/products/product-4-2.jpg')}}" width="250" height="250" alt="product">
                                    </a>
                                </figure>
                            ...
                            <div class="col-sm-12 col-6 product-default left-details product-list mb-2">
                                <figure>
                                    <a href="product.html">
                                        <img src="{{asset('assets/images/products/product-5.jpg')}}" width="250" height="250" alt="product" />
                                        <img src="{{asset('assets/images/products/product-5-2.jpg')}}" width="250" height="250" alt="product" />
                                    </a>
                                </figure>
                            ...
                            <div class="col-sm-12 col-6 product-default left-details product-list mb-2">
                                <figure>
                                    <a href="product.html">
                                        <img src="{{asset('assets/images/products/product-6.jpg')}}" width="250" height="250" alt="product">
                                        <img src="{{asset('assets/images/products/product-6-2.jpg')}}" width="250" height="250" alt="product" />
                                    </a>
                                </figure>
