    ...
    <aside class="sidebar sidebar-base sidebar-white sidebar-default navs-rounded-all " id="first-tour" data-toggle="main-sidebar" data-sidebar="responsive">
        ...
        <div class="sidebar-body pt-0 data-scrollbar">
            <div class="sidebar-list">
                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                        <a class="nav-link"  href="{{ route('admin.categoria.index') }}" >
                            ...
                            <span class="item-name">Tipos de <br> Estabelecimentos</span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link"  href="{{ route('admin.comissao.index') }}" >
                            ...
                            <span class="item-name">Comissão</span>
                    ...
                    <li class="nav-item">
                         <a class="nav-link " href="{{route('admin.armazem.index')}}">
                            ...
                            <span class="item-name">Estabelecimentos</span>
                   ...
                   <li class="nav-item">
                    <a class="nav-link " href="{{route('admin.cor.index')}}">
                       ...
                       <span class="item-name">Categosrias dos <br> Produtos</span>
               ...
               <li class="nav-item">
                <a class="nav-link " href="{{route('admin.especies.index')}}">
                   ...
                   <span class="item-name">Categosrias dos <br> Especíes</span>
           ...
           <li class="nav-item">
            <a class="nav-link " href="{{route('admin.racas.index')}}">
               ...
               <span class="item-name">Categosrias dos <br> Raças</span>
       ...
       <li class="nav-item">
        <a class="nav-link " href="{{route('admin.animais.index')}}">
           ...
           <span class="item-name">Categosrias dos <br> Animal</span>
   ...
   <li class="nav-item">
    <a class="nav-link " href="{{route('admin.tipolembrete.index')}}">
       ...
       <span class="item-name">Categosrias dos <br> Tipolembrete</span>
...
<li class="nav-item">
    <a class="nav-link " href="{{route('admin.lembretes.index')}}">
       ...
       <span class="item-name">Categosrias dos <br> Lembrete</span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link " href="{{route('admin.produto.index')}}">
                   ...
                   <li class="nav-item">
                    <a class="nav-link " href="{{route('admin.animalpetshop.index')}}">
                       ...
                       <span class="item-name">Animas da Petshop</span>
