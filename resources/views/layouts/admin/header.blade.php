       ...
       <nav class="nav navbar navbar-expand-xl navbar-light iq-navbar">
          <div class="container-fluid navbar-inner">
             <a href="/" class="navbar-brand">
                ...
                <!--logo End-->         <h4 class="logo-title d-block d-xl-none" data-setting="app_name">ItelBook</h4>
             </a>
                 ...
                 <div class="offcanvas offcanvas-end shadow-none iq-product-menu-responsive" tabindex="-1" id="offcanvasBottom">
                   <div class="offcanvas-body">
                      <ul class="iq-nav-menu list-unstyled">
                         <li class="nav-item ">
                            <a class="nav-link menu-arrow justify-content-start active" data-bs-toggle="collapse" href="{{ route('admin.user.index') }}" role="button" aria-expanded="false" aria-controls="homeData">
                               ...
                               <span class="nav-text ms-2">Início</span>
                            </a>
                            ...
                            <ul class="iq-header-sub-menu list-unstyled collapse" id="elementsData">
                               ...
                               <li class="nav-item">
                                  ...
                                  <ul aria-expanded="false" class="iq-header-sub-menu left list-unstyled collapse" id="tablesPages">
                                     ...
                                     <li class="nav-item"><a class="nav-link active" href="../../dashboard/table/table-data.html">Data Table</a></li>
                                  </ul>
                               </li>
                               <li class="nav-item">
