            ...
            <nav class="main-nav w-100">
                <ul class="menu">
                    ...
                    <li><a href="{{ url('produtos') }}">Produtos</a></li>
                     ...
                     <li><a href="{{ url('blog') }}">Blogue</a></li>

                      <li><a href="{{ url('sobre') }}">Sobre Nós</a></li>

                   
                    <li><a href="{{ url('contacte') }}">Contacte-nos</a></li>
                    ...
                    @else
                        <li><a href="/login">Iniciar Secção</a></li>
                        <li><a href="/register">Registrar-se</a></li>
                    @endif
                    @auth
                    <li class="float-right"><a href=""  class="pl-5" >{{ Auth::user()->name }}</a></li>
                    {{-- <li class="float-right"><a href="#" class="pl-5">right2</a></li>  --}}
                    @endauth
                </ul>
            </nav>
        </div>
