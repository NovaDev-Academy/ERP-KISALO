          ...
          <div class="card">
             <div class="card-header d-flex justify-content-between">
                <div class="header-title">
                   <h4 class="card-title">Categoria dos Serviços</h4>
                </div>
                <div>
             ...
             <div class="card-body">
                   ...
                   <table id="input-datatable" class="table" data-toggle="data-table-column-filter">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-sm btn-icon btn-warning rounded" data-bs-toggle="modal"data-bs-target=".bd-example-modal-xl{{$sub_categoria->id}}"  >
                                 ...
                                 <a class="btn btn-sm btn-icon btn-danger rounded" data-bs-toggle="tooltip" data-placement="top" title="" data-bs-original-title="Eliminar" href="{{route('admin.sub_categoria.delete', $sub_categoria->id)}}">
                                    <span class="btn-inner">
                ...
                <div class="modal fade bd-example-modal-xl{{$sub_categoria->id}}" tabindex="-1" role="dialog"   aria-hidden="true">
