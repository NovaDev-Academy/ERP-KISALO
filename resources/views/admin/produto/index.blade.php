                ...
                <div class="table-responsive">
                   <table id="input-datatable" class="table" data-toggle="data-table-column-filter">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{$produto->id}}</td>
                            <td>{{$produto->vc_nome}}</td>
                           
                            <td>
                                {{$produto->categoria_produto}}
                            </td>
                            <td>{{$produto->it_quantidade}}</td>
                            <td>{{$produto->fl_preco}}</td>
                            ...
                            <td>
                                <a class="btn btn-sm btn-icon btn-warning rounded" data-bs-toggle="modal"data-bs-target=".bd-example-modal-xl{{$produto->id}}"  >
                                 ...
                                 <a class="btn btn-sm btn-icon btn-danger rounded" data-bs-toggle="tooltip" data-placement="top" title="" data-bs-original-title="Eliminar" href="{{route('admin.produto.delete', $produto->id)}}">
                                    <span class="btn-inner">
