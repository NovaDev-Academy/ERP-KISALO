                   ...
                   <table id="input-datatable" class="table" data-toggle="data-table-column-filter">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                              <a href="{{asset($user->cv)}}" target="_blank">{{$user->cv}}</a> </td>
                              {{-- <a href="#" onclick="window.open('{{ $user->cv }}', '_blank'); return false;">Curriculum Vitae</a> --}}
                          </td>
                          

                            <td>
                                {{-- <a class="btn btn-sm btn-icon btn-warning rounded" data-bs-toggle="modal"data-bs-target=".bd-example-modal-xl{{$user->id}}"  >
                                    gomesfranciscomateys<span class="btn-inner">
                                 ...
                                 @if($user->estado==0)
                                       <a class="btn btn-sm btn-icon btn-success rounded" data-bs-toggle="tooltip" data-placement="top" title="" data-bs-original-title="Aprovar" href="{{route('admin.prestador.activar', $user->id)}}">
                                 ...
                                 @else
                                 <a class="btn btn-sm btn-icon btn-danger rounded" data-bs-toggle="tooltip" data-placement="top" title="" data-bs-original-title="Desaprovar" href="{{route('admin.prestador.desativar', $user->id)}}">
                                    <span class="btn-inner">
