        ...
        <div class="col-lg-8">
            <div class="row">
                    ...
                    <div class="card card-block card-stretch card-height">
                        <div class="card-header">
                            <div class="header-title">
                                <h4 class="text-center">Quantidade de utilizadores que baixaram o aplicativo <br>e se registaram no aplicativo</h4>
                            </div>
                        </div>
                        <div class="card-body">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card-header">
                            <div class="header-title">
                                <h4 class="text-center">Quantidade de utilizadores que solicitaram os serviços</h4>
                            </div>
                        </div>
                        <div class="card-body">
                            <div id="chart-01"></div>
                ...
                <div class="col-lg-12">
                    <div class="card card-block card-stretch card-height">
                        <div class="card-header">
                                <div class="header-title">
                                    <h4 class="text-center">Quantidade de utilizadores que solicitaram e <br>cancelaram os serviços</h4>
                                </div>
                        </div>
                        <div class="card-body">
                            <div id="chart-03"></div>
            ...
            <div class="col-lg-12">
                   <div class="card card-block card-stretch card-height">
                        <div class="flex-wrap card-header d-flex justify-content-between align-items-center">
                            <div class="header-title text-center">
                                <h4>Quantidade de devoluções de valores realizadas</h4>
                            </div>

                        </div>
                        <div class="card-body">
                            <div id="chart-02" class="analytics-chart-02"></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                   <div class="card card-block card-stretch card-height">
                        <div class="flex-wrap card-header d-flex justify-content-between align-items-center">
                            <div class="header-title">
                                <h4 class="text-center">Quantidade de serviços que se encontram pendentes para realização</h4>
                            </div>
                            <!-- <div class="dropdown">
