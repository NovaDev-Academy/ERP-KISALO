       ...
       <div class="col-sm-12">
          <div class="card">
             ...
             <div class="card-body">
                   ...
                   <table id="input-datatable" class="table" data-toggle="data-table-column-filter">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td> {{$animal->genero}}</td> 
                            <td> {{$animal->peso}}</td>    
                            <td> {{$animal->nome_esp}}</td>  
                            <td> {{$animal->nome_raca}}</td>       
                            <td> {{$animal->name}}</td>  
                            <td> {{$animal->data_nascimento}}</td>  

                            <td>
                                <a class="btn btn-sm btn-icon btn-warning rounded" data-bs-toggle="modal"data-bs-target=".bd-example-modal-xl{{$animal->id}}"  >
                                 ...
                                 <a class="btn btn-sm btn-icon btn-danger rounded" data-bs-toggle="tooltip" data-placement="top" title="" data-bs-original-title="Eliminar" href="{{route('admin.animais.delete', $animal->id)}}">
                                    <span class="btn-inner">
                ...
                <div class="modal fade bd-example-modal-xl{{$animal->id}}" tabindex="-1" role="dialog"   aria-hidden="true">
