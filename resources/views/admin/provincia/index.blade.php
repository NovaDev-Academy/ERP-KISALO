       ...
       <div class="col-sm-12">
          <div class="card">
             ...
             <div class="card-body">
                   ...
                   <table id="input-datatable" class="table" data-toggle="data-table-column-filter">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$provincia->categoria}}</td>


                            <td>
                                <a class="btn btn-sm btn-icon btn-warning rounded" data-bs-toggle="modal"data-bs-target=".bd-example-modal-xl{{$provincia->id}}"  >
                                 ...
                                 <a class="btn btn-sm btn-icon btn-danger rounded" data-bs-toggle="tooltip" data-placement="top" title="" data-bs-original-title="Eliminar" href="{{route('admin.provincia.delete', $provincia->id)}}">
                                    <span class="btn-inner">
                ...
                <div class="modal fade bd-example-modal-xl{{$provincia->id}}" tabindex="-1" role="dialog"   aria-hidden="true">
