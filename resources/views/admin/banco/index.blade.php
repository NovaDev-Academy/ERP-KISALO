          ...
          <div class="card">
             <div class="card-header d-flex justify-content-between">
                <div class="header-title">
                   <h4 class="card-title">Dados Bancarios</h4>
                </div>
                <div>
                    <button type="button" class="btn btn-primary mt-2" data-bs-toggle="modal" data-bs-target=".bd-example-modal-xl">Cadastrar Dados Bancarios
             ...
             <div class="card-body">
                   ...
                   <table id="input-datatable" class="table" data-toggle="data-table-column-filter">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$banco->conta}}</td>
                            <td>
                                <a class="btn btn-sm btn-icon btn-warning rounded" data-bs-toggle="modal"data-bs-target=".bd-example-modal-xl{{$banco->id}}"  >
                                 ...
                                 <a class="btn btn-sm btn-icon btn-danger rounded" data-bs-toggle="tooltip" data-placement="top" title="" data-bs-original-title="Eliminar" href="{{route('admin.banco.delete', $banco->id)}}"">
                                    <span class="btn-inner">
                ...
                <div class="modal fade bd-example-modal-xl{{$banco->id}}" tabindex="-1" role="dialog"   aria-hidden="true">
                    <div class="modal-dialog modal-xl">
                       <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form action="{{route('admin.banco.update',$banco->id)}}" method="post" enctype="multipart/form-data">
                                @csrf

                                @include('admin.banco.form')
                ...
                <div class="modal fade bd-example-modal-xl" tabindex="-1" role="dialog"   aria-hidden="true">
                    <div class="modal-dialog modal-xl">
                       <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form action="{{route('admin.banco.store')}}" method="post" enctype="multipart/form-data">
                                @csrf
                 ...
                 <script>
                     $(document).ready(function () {
                         $('#categorias_id').change(function () {
                             ...
                             $.ajax({
                                 url: '/admin/banco/get-subcategoria-descricao/' + categoriaId,
                                 type: 'GET',
