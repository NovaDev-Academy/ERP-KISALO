...
<div class="content-inner container-fluid pb-0" id="page_layout">
       ...
       <div class="col-sm-12">
          <div class="card">
             ...
             <div class="card-body">
                   ...
                   <table id="input-datatable" class="table" data-toggle="data-table-column-filter">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            {{-- <td>
                                @if ($empresa->pagamento==0)
                                Pendente
                                @elseif ($empresa->pagamento==1)
                                    Realizado
                                @else
                                    Não Realizado
                                @endif
                            ...
                            <td>
                                <a class="btn btn-sm btn-icon btn-warning rounded" data-bs-toggle="modal"data-bs-target=".bd-example-modal-xl{{$empresa->id}}"  >
                                 ...
                                 <a class="btn btn-sm btn-icon btn-danger rounded" data-bs-toggle="tooltip" data-placement="top" title="" data-bs-original-title="Eliminar" href="{{route('admin.empresa.delete', $empresa->id)}}"">
                                    <span class="btn-inner">
                ...
                <div class="modal fade bd-example-modal-xl{{$empresa->id}}" tabindex="-1" role="dialog"   aria-hidden="true">
    ...
    <script>
        Swal.fire(
            'Estabelecimento Eliminado com sucesso!',
            '',
            'success'
        )
    </script>
